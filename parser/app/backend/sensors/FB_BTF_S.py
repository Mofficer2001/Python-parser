...
class FB_BTF_S(Sensor):
    ...
    def to_hmi(self, x: int, y: int) -> str:
        hmi_block = (
            f'    <object access-modifier="private" name="{getattr(self, self.Name.key)}" display-name="{getattr(self, self.Name.key)}" uuid="{self.pk}" base-type="FB_BTF_S" base-type-id="e2ad2d7d-eef7-4eda-8a13-e5db5d0f6989" ver="5" description="" cardinal="1">\n'
